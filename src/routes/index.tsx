    ...
    <div className="min-h-screen bg-paper text-ink font-body antialiased selection:bg-accent/15">
      ...
      <main id="topo" className="mx-auto max-w-6xl px-4 pt-24 pb-16 sm:px-6 sm:pt-28 sm:pb-20">
        ...
        <section id="projeto" className="mt-16 md:mt-24">
          <Reveal className="border-y-4 border-accent px-0 py-10 sm:px-2 sm:py-14">
            <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
              {/* Esquerda */}
              <div className="flex-1">
                <span className="mb-4 block font-mono text-[10px] font-semibold uppercase tracking-[0.22em] text-accent">
                  [ Projeto em destaque · 2026 ]
                </span>
                <h2 className="font-display text-[clamp(2.2rem,6vw,4.2rem)] font-bold italic leading-[1.05] tracking-tight">
                  Chatbot de
                  <br />
                  WhatsApp com IA
                </h2>
                <p className="mt-6 max-w-md text-pretty text-[17px] leading-relaxed opacity-90">
                  Arquitetura completa de atendimento automatizado no WhatsApp, integrando geração de
                  respostas por IA, persistência de dados em tempo real e continuidade humana.
                </p>

                <div className="mt-10">
                  <h3 className="mb-4 font-mono text-[11px] uppercase tracking-[0.16em] text-accent">
                    Entregas principais
                  </h3>
                  <ul className="space-y-2 text-[14px] leading-relaxed">
                    {[
                      "Orquestração de fluxos e webhooks no n8n.",
                      "Integração direta com a API da Meta (WhatsApp Business).",
                      "Respostas contextuais com a API do GPT.",
                      "Memória e banco de dados no Supabase.",
                      "Transbordo para atendimento humano no Chatwoot.",
              ...
              {/* Direita */}
              <div className="flex w-full flex-col gap-8 md:w-80 md:shrink-0">
                <div className="border border-line bg-[#EAE7E0] p-6">
                  <h3 className="mb-6 border-b border-line pb-2 font-mono text-[10px] uppercase tracking-[0.2em]">
                    Fluxo de dados
                  </h3>
                  <div className="space-y-4 font-mono text-[11px]">
                    <div className="flex items-center gap-3">
                      <span className="bg-ink px-2 py-1 text-paper">WhatsApp</span>
                      <span className="text-accent">→</span>
                      <span className="border border-ink px-2 py-1">n8n</span>
                    </div>
                    <div className="ml-8 text-accent">↓</div>
                    <div className="ml-4 flex items-center gap-3">
                      <span className="border border-ink px-2 py-1">GPT API</span>
                      <span className="text-accent">↔</span>
                      <span className="border border-ink px-2 py-1">Supabase</span>
                    </div>
                    <div className="ml-8 text-accent">↓</div>
                    <div className="flex items-center gap-3">
                      <span className="bg-accent px-2 py-1 text-paper">Chatwoot</span>
                    </div>
                  </div>
                </div>

                <div className="flex flex-wrap gap-2">
                  {["n8n", "Supabase", "Meta API", "Chatwoot", "GPT API", "Google API"].map((t) => (
                    <span
                      key={t}
                      className="border border-ink px-2 py-0.5 font-mono text-[10px] transition-colors duration-300 hover:bg-ink hover:text-paper"
                    >
                      {t}
                    </span>
                  ))}
